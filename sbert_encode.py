...
questions= list(sample_data['title'])
...
# printing sample encoding/embedding for one question
print('Sample BERT embedding vector - length', len(sbert_embedding[0]))
print('Sample BERT embedding vector - note includes negative values', sbert_embedding[0])